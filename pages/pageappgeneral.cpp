...
void PageAppGeneral::setVesc(VescInterface *vesc)
{
    ...
    if (mVesc) {
        ui->appTab->addRowSeparator(tr("App Settings"));
        ...
        ui->appTab->addRowSeparator(tr("Power Switch Settings"));
        ui->appTab->addParamRow(mVesc->appConfig(), "app_smart_switch_conf.push_to_start_enabled");
        ui->appTab->addParamRow(mVesc->appConfig(), "app_smart_switch_conf.msec_pressed_for_off");
        ui->appTab->addParamRow(mVesc->appConfig(), "app_smart_switch_conf.sec_inactive_for_off");
